  ...
  final Map<String, List<Cafe>> _cafeMenu = {
    ...
    'coldbrew': [
      ...
      Cafe(
        ...
        discription:
            '무더운 여름철,동남아 휴가지에서 즐기는\n커피를 떠오르게 하는 베스트 x 베스트 조합인\n돌체 콜드 브루를 만나보세요!',
        price: '6,000',
      ...
      Cafe(
        ...
        discription:
            '콜드 브루의 풍미와 깔끔한 오트음료\n(식물성 대체유)가 어우러진 달콤 고소한 라떼.\n식물성 대체유를 사용해 모든 고객이\n부담없이 즐길 수 있는 콜드 브루 음료',
        price: '6,000',
    ...
    'teabana': [
      Cafe(
        ...
        discription:
            '슈크림의 색다른 변신! 봄을 알리는 초록&노랑의\n비주얼과 쌉싸름한 말차, 달콤한 슈크림이\n잘 어우러진 티 라떼 음료',
        price: '6,500',
      ...
      Cafe(
        ...
        discription:
            '찻잎을 직접 우려 만든 상큼하고 청량한\n아이스 티로, 복숭아의 진한 맛과 홍차의\n풍미를 느낄 수 있는 음료',
        price: '6,100',
      ...
      Cafe(
        ...
        discription: '진하게 오래 우려낸 티바나 블랙 티의\n깊은 풍미와 우유의 조화로움을\n담아낸 맛에 집중한 밀크 티',
        price: '6,100',
      ...
      Cafe(
        ...
        discription: '달콤한 고흥 유자와 알싸하고 은은한 진저,\n우릴 수록 상쾌한 민트 티가\n조화로운 유자 민트 티',
        price: '6,100',
      ...
      Cafe(
        ...
        discription: '유기농 녹차 티백만을 100%(물 제외)\n사용한 티로 맑은 수색과\n고유의 풍미가 뛰어난 녹차',
        price: '5,300',
      ...
      Cafe(
        ...
        discription: '인도 아삼, 제주도 유기농 홍차가\n블렌딩되어 진한 벌꿀향과 그윽한 몰트향이\n특징인 블랙 티',
        price: '4,500',
      ...
      Cafe(
        ...
        discription: '꽃향 가득한 라벤더와 베르가못 향이\n진한 홍차와 블렌딩된 향긋한 블랙 티',
        price: '4,500',
      ...
      Cafe(
        ...
        discription:
            '제주산 찻잎으로 만든 황차에 사과, 망고,\n파인애플, 히비스커스, 로즈힙 등이 블렌딩되어\n핑크빛 컬러가 감도는 수색과 베리류의\n새콤함을 느낄 수 있는 옐로우 티',
        price: '4,500',
      ...
      Cafe(
        ...
        discription: '히비스커스, 사과, 파파야, 망고, 레몬그라스\n등이 블렌딩된 상큼한 허브 티',
        price: '4,500',
